...
exports.PreAuditRecon = void 0;
const fetcher_1 = require("./fetcher");
const ssrf_1 = require("./ssrf");
class PreAuditRecon {
    guard;
    fetchFn;
    constructor(guard, fetchFn) {
        this.guard = guard ?? new ssrf_1.SSRFGuard();
        this.fetchFn = fetchFn ?? fetcher_1.secureFetch;
    }
    async analyze(urlStr) {
        ...
        try {
            ...
            // 2. Akamai Detection
            if (serverHeader.includes('akamaighost') ||
            ...
            // 4. General CAPTCHAs
            if (html.includes('recaptcha/api.js') ||
...
exports.PreAuditRecon = PreAuditRecon;
